...
export function TotpSetup() {
  ...
  return (
    <div className="space-y-6">
      ...
      {/* Error */}
      {error && (
        <div className="animate-in flex items-center gap-2 rounded-xl bg-red-50 px-4 py-3 text-sm text-red-600 ring-1 ring-red-200 dark:bg-red-950/30 dark:text-red-400 dark:ring-red-500/20">
      ...
      {/* QR Code step */}
      {step === 'qr' && (
        <div className="animate-in space-y-6 rounded-2xl bg-white p-6 ring-1 ring-zinc-200 dark:bg-zinc-900 dark:ring-white/10">
