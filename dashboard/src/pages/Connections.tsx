...
function EmptyState({ oauthProviders }: { oauthProviders: Status['oauthProviders'] }) {
  return (
    <motion.div 
      ...
      className="flex flex-col items-center justify-center rounded-[32px] border-2 border-dashed border-zinc-200 bg-zinc-50/50 py-20 px-6 text-center dark:border-zinc-800 dark:bg-white/[0.02]"
    >
