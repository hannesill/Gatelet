    ...
    <div className="login-gradient relative flex min-h-screen flex-col items-center justify-center overflow-hidden px-4">
      ...
      <div className="animate-in relative w-full max-w-[400px]">
        ...
        <div className="mb-10 text-center">
          <div className="animate-scale stagger-2 mx-auto mb-6 flex h-16 w-16 items-center justify-center rounded-2xl bg-indigo-600 shadow-2xl shadow-indigo-500/40 ring-4 ring-white dark:ring-zinc-950">
            <Logo className="h-9 w-9 text-white" />
          </div>
          <h1 className="animate-fade stagger-3 font-[Fraunces] text-3xl font-bold italic text-zinc-900 dark:text-white">
            Gatelet
          </h1>
          <p className="animate-fade stagger-4 mt-2 text-zinc-500 dark:text-zinc-400">
