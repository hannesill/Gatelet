...
import { applyMutation, applyMutations } from '../../src/policy/mutations.js';

describe('set mutation', () => {
  it('sets a top-level field', () => {
    const params: Record<string, unknown> = { summary: 'Test' };
    applyMutation({ field: 'visibility', action: 'set', value: 'private' }, params);
  ...
  it('sets a nested field, creating intermediates', () => {
    ...
    applyMutation({ field: 'location.displayName', action: 'set', value: 'Office' }, params);
  ...
  it('sets array values', () => {
    ...
    applyMutation({ field: 'attendees', action: 'set', value: [] }, params);
    expect(params.attendees).toEqual([]);
  });

  it('sets boolean values', () => {
    const params: Record<string, unknown> = {};
    applyMutation({ field: 'guestsCanModify', action: 'set', value: false }, params);
...
describe('delete mutation', () => {
  it('deletes an existing field', () => {
    ...
    applyMutation({ field: 'description', action: 'delete' }, params);
  ...
  it('does not error when deleting a missing field', () => {
    const params: Record<string, unknown> = { summary: 'Test' };
    applyMutation({ field: 'nonexistent', action: 'delete' }, params);
